...
This is a helm chart for bom-service-python

## Configuration

### Value files

The configurations and settings that are applied to an instance of the bom-service-python running on k8s are determined by combining the following values files

* The `values.yaml` file in the root directory. This contains the default configurations for all instances of bom-service-python
...
| `resources.limits.cpu` | Max cpu required by bom-service-python  |
| `resources.limits.memory` | Max memory required by bom-service-python   |
...
| `environmentVariables` | Map of the environment variables required by bom-service-python. See the **Environment Variables** section above  |
| `environmentSecrets` | Map of the secrets provided as environment variables to bom-service-python. See the **Environment Secrets** section above   |
