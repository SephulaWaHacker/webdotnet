...
This is a helm chart for parts-service-java

## Configuration

### Value files

The configurations and settings that are applied to an instance of the parts-service-java running on k8s are determined by combining the following values files

* The `values.yaml` file in the root directory. This contains the default configurations for all instances of parts-service-java
...
| `resources.limits.cpu` | Max cpu required by parts-service-java  |
| `resources.limits.memory` | Max memory required by parts-service-java   |
...
| `environmentVariables` | Map of the environment variables required by parts-service-java. See the **Environment Variables** section above  |
| `environmentSecrets` | Map of the secrets provided as environment variables to parts-service-java. See the **Environment Secrets** section above   |
