# vehicle-order-service-ui

This is a helm chart for vehicle-order-service-ui

## Configuration

### Value files

The configurations and settings that are applied to an instance of the vehicle-order-service-ui running on k8s are determined by combining the following values files

* The `values.yaml` file in the root directory. This contains the default configurations for all instances of vehicle-order-service-ui
...
| `resources.limits.cpu` | Max cpu required by vehicle-order-service-ui  |
| `resources.limits.memory` | Max memory required by vehicle-order-service-ui   |
...
| `environmentVariables` | Map of the environment variables required by vehicle-order-service-ui. See the **Environment Variables** section above  |
| `environmentSecrets` | Map of the secrets provided as environment variables to vehicle-order-service-ui. See the **Environment Secrets** section above   |
